...
!function (a) {
    ...
    a.fn.datetimepicker = function (b) {
        ...
        enabledDates: !1,
        icons: {
            time: " icon-access_time",
            date: "icon-perm_contact_calendar",
            up: "icon-keyboard_arrow_up",
            down: "icon-keyboard_arrow_down",
            previous: " icon-keyboard_arrow_left",
            next: "icon-keyboard_arrow_right",
            today: " icon-screen_share",
            clear: "icon-trash",
            close: "icon-highlight_remove"
        },
        tooltips: {
            today: "Go to today",
...
(function () {
    ...
    t = jQuery, s = function () {
        ...
        return t.transitions = {
            ...
            var s, i, n, e;
            s = t[0], i = this.transitions;
            for (e in i) if (n = i[e], null != s.style[e]) return n
        }, t
    }(), i = function () {
        function i(s) {
            null == s && (s = {}), this.container = n(this.container, this), this.content = n(this.content, this), this.html = n(this.html, this), this.$growl = n(this.$growl, this), this.$growls = n(this.$growls, this), this.animate = n(this.animate, this), this.remove = n(this.remove, this), this.dismiss = n(this.dismiss, this), this.present = n(this.present, this), this.waitAndDismiss = n(this.waitAndDismiss, this), this.cycle = n(this.cycle, this), this.close = n(this.close, this), this.click = n(this.click, this), this.mouseLeave = n(this.mouseLeave, this), this.mouseEnter = n(this.mouseEnter, this), this.unbind = n(this.unbind, this), this.bind = n(this.bind, this), this.render = n(this.render, this), this.settings = t.extend({}, i.settings, s), this.$growls().attr("class", this.settings.location), this.render()
        }
        ...
        return i.settings = {
            ...
            return null == t && (t = {}), this.initialize(), new i(t)
            ...
            return null == t && (t = this.$growl()), t.on("click", this.click), this.settings.delayOnHover && (t.on("mouseenter", this.mouseEnter), t.on("mouseleave", this.mouseLeave)), t.on("contextmenu", this.close).find("." + this.settings.namespace + "-close").on("click", this.close)
        }, i.prototype.unbind = function (t) {
            return null == t && (t = this.$growl()), t.off("click", this.click), this.settings.delayOnHover && (t.off("mouseenter", this.mouseEnter), t.off("mouseleave", this.mouseLeave)), t.off("contextmenu", this.close).find("." + this.settings.namespace + "-close").off("click", this.close)
        }, i.prototype.mouseEnter = function (t) {
            var s;
            return s = this.$growl(), s.stop(!0, !0)
        }, i.prototype.mouseLeave = function (t) {
            return this.waitAndDismiss()
        }, i.prototype.click = function (t) {
            return null != this.settings.url ? (t.preventDefault(), t.stopPropagation(), window.open(this.settings.url)) : void 0
        }, i.prototype.close = function (t) {
            var s;
            return t.preventDefault(), t.stopPropagation(), s = this.$growl(), s.stop().queue(this.dismiss).queue(this.remove)
        }, i.prototype.cycle = function () {
            var t;
            return t = this.$growl(), t.queue(this.present).queue(this.waitAndDismiss())
        }, i.prototype.waitAndDismiss = function () {
            var t;
            return t = this.$growl(), t.delay(this.settings.duration).queue(this.dismiss).queue(this.remove)
        }, i.prototype.present = function (t) {
            var s;
            return s = this.$growl(), this.bind(s), this.animate(s, this.settings.namespace + "-incoming", "out", t)
        }, i.prototype.dismiss = function (t) {
            var s;
            return s = this.$growl(), this.unbind(s), this.animate(s, this.settings.namespace + "-outgoing", "in", t)
        }, i.prototype.remove = function (t) {
            return this.$growl().remove(), "function" == typeof t ? t() : void 0
        }, i.prototype.animate = function (t, i, n, e) {
            var o;
            null == n && (n = "in"), o = s.transition(t), t["in" === n ? "removeClass" : "addClass"](i), t.offset().position, t["in" === n ? "addClass" : "removeClass"](i), null != e && (null != o ? t.one(o, e) : e())
        }, i.prototype.$growls = function () {
            return null != this.$_growls ? this.$_growls : this.$_growls = t("#growls")
        }, i.prototype.$growl = function () {
        ...
        }, i.prototype.container = function (t) {
            return "<div class='" + this.settings.namespace + " " + this.settings.namespace + "-" + this.settings.style + " " + this.settings.namespace + "-" + this.settings.size + "'>\n  " + t + "\n</div>"
        }, i
    }(), this.Growl = i, t.growl = function (t) {
        return null == t && (t = {}), i.growl(t)
    }, t.growl.error = function (s) {
        var i;
        return null == s && (s = {}), i = {title: "", style: "error"}, t.growl(t.extend(i, s))
    }, t.growl.success = function (s) {
        var i;
        return null == s && (s = {}), i = {title: "", style: "success"}, t.growl(t.extend(i, s))
    }, t.growl.notice = function (s) {
        var i;
        return null == s && (s = {}), i = {title: "", style: "notice"}, t.growl(t.extend(i, s))
    }, t.growl.warning = function (s) {
        var i;
        return null == s && (s = {}), i = {title: "", style: "warning"}, t.growl(t.extend(i, s))
    }
}).call(this);
...
!function (t, i) {
    ...
    return function (t) {
        ...
        function e(i, e) {
            ...
            var P = ["round", "triangle", "custom"], T = -1 !== P.indexOf(this.options.handle);
            if (T) for (this._addClass(this.handle1, this.options.handle), this._addClass(this.handle2, this.options.handle), a = 0; a < this.ticks.length; a++) this._addClass(this.ticks[a], this.options.handle);
        ...
        if (i = function (t, i) {
            ...
            _layout: function () {
                ...
                if ("vertical" === this.options.orientation) this.trackLow.style.top = "0", this.trackLow.style.height = Math.min(t[0], t[1]) + "%", this.trackSelection.style.top = Math.min(t[0], t[1]) + "%", this.trackSelection.style.height = Math.abs(t[0] - t[1]) + "%", this.trackHigh.style.bottom = "0", this.trackHigh.style.height = 100 - Math.min(t[0], t[1]) - Math.abs(t[0] - t[1]) + "%"; else {
                    ...
                    p.right > d.left ? (this._removeClass(this.tooltip_max, "top"), this._addClass(this.tooltip_max, "bottom"), this.tooltip_max.style.top = "18px") : (this._removeClass(this.tooltip_max, "bottom"), this._addClass(this.tooltip_max, "top"), this.tooltip_max.style.top = this.tooltip_min.style.top)
                }
            },
